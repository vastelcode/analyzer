        ...
        if type_search == 'deep':
            while True:
                ...
                for index, element in enumerate(list_all):
                    ...
                    if os.path.isfile(os.path.join(root_directory, element)):
                        name, extension = os.path.splitext(
                            os.path.join(root_directory, element)
                        )

                        # если расширение файла есть в переданных
                        if extension in extensions:
                            files.append(os.path.join(root_directory, element))

                    elif os.path.isdir(os.path.join(root_directory, element)):
                        dirs.append(element)
